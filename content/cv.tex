...
\newcommand{\hobby}[3]{\hbox{{\Large{#1}}\quad\parbox{5.5cm}{\entrytitlestyle{#2}\\[-0.2em]{\descriptionstyle{#3}}}}}%

% Available options: circle|rectangle,edge/noedge,left/right
\photo[circle,edge,left]{images/Bewerbungsfoto.JPG}
...
\begin{cventries}
    ...
    {Technical University Dortmund} % Institution
...
\hbox{%
    ...
    \hfill%
    \hobby{\faIcon[regular]{comments}}{politics}{local and digital orientation}%
    \hfill%
